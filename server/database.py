...
if __name__ == "__main__":
    ...
    # desc = "Learn how to make a sushi sandwich, also known as onigirazu a fun and creative twist on traditional sushi that's beginnerfriendly and incredibly satisfying. We'll guide you through preparing perfectly seasoned sushi rice, layering fresh ingredients like salmon, avocado, cucumber, and spicy mayo, then wrapping everything tightly in nori for a neat, handheld meal. Whether you're packing lunch, heading to a picnic, or just craving something different, this recipe is quick to make and easy to customize with your favorite proteins and vegetables. No rolling mat required just simple, delicious sushi in sandwich form"
