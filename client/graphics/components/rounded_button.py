...
class RoundedButton(wx.Panel):
    def __init__(self, parent, label, base_color = settings.UNACTIVE_BUTTON, background_color = settings.OFF_WHITE, radius = settings.ROUND_BORDER_RADIUS, font_size = settings.BUTTON_TEXT_FONT_SIZE):
        """
